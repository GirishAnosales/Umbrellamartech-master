...
import { Week, EmployeeSize, ContactAgain, BuyingProcess, Budget, TechSolution, User } from 'src/app/interfaces/interface';
...
@Component({
	selector: 'app-dell-vostro-q3',
	templateUrl: './dell-vostro-q3.component.html',
	styleUrls: ['./dell-vostro-q3.component.scss']
})
export class DellVostroQ3Component {
	...
	onSubmit(user: User) {
		...
		formData.append('Coming from', 'Dell Vostro Q3');
