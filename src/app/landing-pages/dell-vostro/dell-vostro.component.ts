...
@Component({
	selector: 'app-dell-vostro',
	templateUrl: './dell-vostro.component.html',
	styleUrls: ['./dell-vostro.component.scss']
})
export class DellVostroComponent {
	...
	onSubmit(user: User) {
		...
		formData.append('Coming from', 'Dell Vostro');
