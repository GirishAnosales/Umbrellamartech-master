...
@Component({
	selector: 'app-dell-optiplex',
	templateUrl: './dell-optiplex.component.html',
	styleUrls: ['./dell-optiplex.component.scss']
})
export class DellOptiplexComponent {
	...
	onSubmit(user: User) {
		...
		formData.append('Coming from', 'Dell Optiplex');
