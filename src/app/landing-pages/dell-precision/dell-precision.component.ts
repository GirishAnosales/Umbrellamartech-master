...
@Component({
	selector: 'app-dell-precision',
	templateUrl: './dell-precision.component.html',
	styleUrls: ['./dell-precision.component.scss']
})
export class DellPrecisionComponent {
	...
	onSubmit(user: User) {
		...
		formData.append('Coming from', 'Dell Precision');
